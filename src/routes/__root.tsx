...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CareConnect AI — Dental, Physiotherapy & NGO Care" },
      {
        name: "description",
        content:
          "Modern dental and physiotherapy clinic management with AI-powered NGO patient assistance prioritization.",
      },
      { property: "og:title", content: "CareConnect AI — Clinic + NGO Care" },
      {
        property: "og:description",
        content: "AI-driven, equitable healthcare for every patient.",
      },
